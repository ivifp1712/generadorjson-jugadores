    ...
    if "nombre" in x:
        ...
        for y in x:
            if y != ",":
                ...
                break
d2 = open("datos/mujeres.csv", "r", encoding="UTF-8")
    ...
    if "nombre" in x:
        ...
        for y in x:
            if y != ",":
                ...
                nombres[len(nombres)-1] = temp.title()
                break
d3 = open("datos/apellidos.csv", "r", encoding="UTF-8")
apellidos = []
...
calles = []
d4 = open('datos/calles.csv', "r", newline='') 
...
with open('datos/data.json', 'w') as file:
